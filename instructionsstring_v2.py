...
called os_api_keys and url at the beginning of the code. The code will then be automatically run by the script that is prompting you.  All inquiries will be concerning Onshape regardless. The first line of all of the python code should be a comment 
