...
these are simply instructions to help guide OnshapeGPT through the template. Please do not include any text that is not code in your responses, and if you do, please add a triple
quote so it does not mess with the code.
...
outside the vector assuming all of the components have the same units. All vectors must have units.
