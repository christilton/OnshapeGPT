...
inputstring = "\nWelcome to OnshapeGPT! What would you like to create today?\n\nUser: "
...
responses.write(f"Model ID:"+ID+"\n")
responses.write(f"Thread ID:{thread.id}\n")
responses.write("OnshapeGPT: Welcome to OnshapeGPT! What would you like to create today?")
