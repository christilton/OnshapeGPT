...
def wait_for_assistant(thread, run):
    ...
    while run.status != 'completed':
        print(f"\r{spinner[spinner_index]} Thinking...", end="", flush=True)
...
inputstring = "Ask OnshapeGPT to create something!\nPrompt: "
...
while True:
    ...
    if before_comment != '':
        print("B:",before_comment, flush = True)
    f = open('TextToCAD.py', 'w')
